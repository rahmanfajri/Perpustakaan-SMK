...
/* measurement in cm */
$sysconf['print']['membercard']['page_margin'] = 6;
$sysconf['print']['membercard']['items_margin'] = 6;
$sysconf['print']['membercard']['items_per_row'] = 7; //
...
// Cardbox Settings
$sysconf['print']['membercard']['box_width'] = 10.6;
$sysconf['print']['membercard']['box_height'] = 7.4;
...
$sysconf['print']['membercard']['front_header2_font_size'] = '5';
...
// Rules
$sysconf['print']['membercard']['rules'] = "<textarea><ul>
<p>Visi</p>
<li>Perpustakaan merupakan jantung informasi dan sebagai pusat kegiatan pembelajaran</li>
<p>Misi</p>
<li>Mengembangkan peran perpustakaan sebagai pengumpul,pengelola,penyaji dan layanan informasi berbasis Teknologi</li>
<li>Meningkatkan minat baca siswa siswi SMK Bukit Asam</li>
<li>Perpustakaan sebagai tempat belajar yang nyaman dan menyenangkan</li>
</ul></textarea>";
