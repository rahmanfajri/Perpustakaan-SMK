...
if (isset($_GET['action']) AND $_GET['action'] == 'print') {
	...
	*/
    ...
    $html_str .= '.exp_div{z-index:18;position: absolute;left: 80px;top: 142px;width:110px;height: 12px;font-size: 8px;text-align: left;}'."\n";
    $html_str .= '.barcode_div{z-index:19;position: absolute;left: 80px;top: 154px;width:150px;height: 42px;}'."\n";
    $html_str .= '</style>'."\n";
    $html_str .= '</head>'."\n";
    $html_str .= '<body>'."\n";
...
<div class="menuBoxInner printIcon">
	...
	<div class="sub_section">
		<div class="btn-group">
		<a target="blindSubmit" href="<?php echo MWB; ?>membership/kartu_barcode_belakang.php?action=clear" class="notAJAX btn btn-default" style="color: #f00;"><i class="glyphicon glyphicon-trash"></i>&nbsp;<?php echo __('Clear Print Queue'); ?></a>
		<a target="blindSubmit" href="<?php echo MWB; ?>membership/kartu_barcode_belakang.php?action=print" class="notAJAX btn btn-default"><i class="glyphicon glyphicon-print"></i>&nbsp;<?php echo __('Print Member Cards for Selected Data'); ?></a>
	    ...
	    <form name="search" action="<?php echo MWB; ?>membership/kartu_barcode_belakang.php" id="search" method="get" style="display: inline;"><?php echo __('Search'); ?>:
