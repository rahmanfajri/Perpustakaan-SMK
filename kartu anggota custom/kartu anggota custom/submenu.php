...
$menu[] = array(__('Kartu Barcode Belakang'), MWB.'membership/kartu_barcode_belakang.php', __('Print Member Card'));
$menu[] = array(__('Kartu Tandatangan Belakang'), MWB.'membership/kartu_tandatangan_belakang.php', __('Print Member Card'));
